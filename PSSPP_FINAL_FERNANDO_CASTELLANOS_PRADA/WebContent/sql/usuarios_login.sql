...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-03-2023 a las 12:02:00
...
INSERT INTO `cuentas` (`idCuenta`, `idUsuario`, `dinero`) VALUES
(1, 1, 2580),
(2, 2, 8620),
(3, 3, 2854),
(4, 4, 3210),
...
(2, 'Carlos', 'Lopez', 'Carloslo@gmail.com', 667455467, 'MTIzNA==', 'MTIzNA==', 0, 'Burgos', 'Anguix'),
(3, 'Antonio', 'Perez', 'AntonioPe@gmail.com', 64578, 'MTIzNA==', 'MTIzNA==', 1, 'Ceuta', 'Ceuta'),
(4, 'Pedro', 'Castellanos Prada', 'feaprad@gmail.com', 667026260, 'MTIzNA==', 'MTIzNA==', 0, 'Madrid', 'Madrid'),
...
--
ALTER TABLE `cuentas`
  MODIFY `idCuenta` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
